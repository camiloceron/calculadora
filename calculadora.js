...
function operacion(oper){
  if(resultado1!=null){
	...
	if(oper!=10){
		if(oper!=operador && operador!=0 && operador!=20 && oper!=5 && oper!=6 && oper!=7 && oper!=8 && oper!=9){operador=operador;}
		else{operador=oper;}		
	}

	if(ban==1 || operador==6 || operador==5 || operador==7 || operador==8 || operador==9)
	{
		if(operador==1 && resultado2!= null){r = parseFloat(resultado1+resultado2);}		
    	else if (operador==2 && resultado2!= null){r = parseFloat(resultado1-resultado2);}
		else if (operador==3 && resultado2!= null){r = parseFloat(resultado1*resultado2);}
		else if (operador==4 && resultado2!= null){
			 if(resultado2==0){document.getElementById("result").value ="Error de division entre 0";}
			else{r = parseFloat(resultado1/resultado2);}	
		}
		else if(operador==5 && resultado1!=null && resultado2==null){//raiz cuadrada
			r = Math.sqrt(resultado1);
			operador=20;
		} 
